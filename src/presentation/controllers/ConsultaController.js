...
class ConsultaController {
    ...
    async obtenerConsulta(req, res){
        ...
        //Aca debo llamar a recibirConsultaCompleta (con el estado 1) que es la ruta del paciente que me tira las consultas completas.
        for (const consulta of consultasNuevas){
    ...
    async obtenerConsultaDni(req, res){
      ...
      //Aca debo llamar a recibirConsultaCompleta (con el estado 2) que es la ruta del paciente que me tira las consultas completas.
      for (const consulta of consultasNuevas){
        console.log("DNI paciente",consulta.paciente.nroDeDocumento);
